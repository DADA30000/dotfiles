...
let
  ...
  man-nix = pkgs.writeShellScriptBin "man-nix" "nvim +Man! ${man-cache}/configuration.nix.cache";
  man-home = pkgs.writeShellScriptBin "man-home" "nvim +Man! ${man-cache}/home-configuration.nix.cache";
in
{
  options.docs = {
