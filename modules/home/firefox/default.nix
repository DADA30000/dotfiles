...
in
{
  ...
  config = mkIf cfg.enable {
	...
	"intl.regional_prefs.use_os_locales" = true;
      ...
      bookmarks = [
        { url = "https://mail.google.com/mail/u/0/#inbox"; name = "first gmail"; }
	...
	{ url = "https://d-obmen.cc/CreateOrder.aspx?s=ADVC-RUB&t=QIWI-RUB"; name = ""; }
	{ url = "https://unix.stackexchange.com/questions/48235/can-i-watch-the-progress-of-a-sync-operation"; name = ""; }
	{ url = "https://ggntw.com/steam"; name = ""; }
	{ url = "https://freevpn4you.net/ru/locations/sweden.php"; name = ""; }
	{ url = "https://forums.unraid.net/topic/127639-easy-anti-cheat-launch-error-cannot-run-under-virtual-machine/"; name = ""; }
	{ url = "https://auto.creavite.co/animated-banners"; name = ""; }
	{ url = "https://positiverecords.ru/"; name = ""; }
	{ url = "https://github.com/Codeusa/Borderless-Gaming/releases"; name = ""; }
	{ url = "https://free-mp3-download.net/"; name = ""; }
	{ url = "https://www.reddit.com/r/LinuxCrackSupport/comments/13vorsd/comment/jtfas0n/"; name = ""; }
	{ url = "https://minecraft-serverlist.com/tools/offline-uuid"; name = ""; }
	{ url = "https://use10.thegood.cloud/apps/files/?dir=/&fileid=10482827"; name = ""; }
	{ url = "https://discourse.nixos.org/t/set-default-application-for-mime-type-with-home-manager/17190"; name = ""; }
	{ url = "https://ryantm.github.io/nixpkgs/using/overlays/#chap-overlays"; name = ""; }
	{ url = "https://ryantm.github.io/nixpkgs/using/overrides/#chap-overrides"; name = ""; }
	{ url = "https://nixos.wiki/index.php?title=Ubuntu_vs._NixOS&useskin=vector"; name = ""; }
	{ url = "https://www.3dgifmaker.com/ClockwiseSpin"; name = ""; }
      ];
    };
  };
}
