...
local user_opts = {
    ...
    language = 'rus',            -- eng=English, chs=Chinese
}
...
local language = {
    ...
    ['rus'] = {
        welcome = '{\\fs24\\1c&H0&\\3c&HFFFFFF&}Перетащите сюда файлы или ссылки для воспроизведения.',  -- this text appears when mpv starts
        off = 'ВЫКЛ',
        na = 'н/д',
        none = 'отсутствует',
        video = 'Видео',
