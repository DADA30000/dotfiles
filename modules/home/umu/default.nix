  ...
  config = mkIf cfg.enable {
    ...
    home.packages = [
      ...
      (pkgs.writeShellScriptBin "umu-run-wrapper" ''
        ...
        UMU_RUNTIME_UPDATE=0 WINEDLLOVERRIDES="winmm.dll=n,b;SteamFix64.dll=n,b;steam_api64.dll=n,b;OnlineFix64.dll=n,b;SteamOverlay64.dll=n,b;version.dll=n,b" ${pkgs.gamemode}/bin/gamemoderun ${pkgs.umu-launcher}/bin/umu-run "$@"
